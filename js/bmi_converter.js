...
function cal_standard_bmi() {
  ...
  if (heightInFeet == "" || heightInInches == "" || weightInPounds == "") {
    ...
    error_box.innerHTML = "";
    if (SBMI < 18.5) {
      result_box.innerHTML = `<div style="background:#9b59b6;color:yellow;box-shadow:0px 0px 5px black;border:1px solid gray;padding:1rem">Your BMI is ${SBMI}.<span style="color:yellow"> You are UnderWeight.Eat Some Extra Food today. Hahaha :)</span><br>
      <a href="index.html" style="display:inline-block;background:#34495e;color:yellow;text-decoration:none;padding:10px">Refresh</a></div>`;
    } else if (SBMI > 18.5 && SBMI < 24.9) {
      result_box.innerHTML = `<div style="background:#9b59b6;color:yellow;box-shadow:0px 0px 5px black;border:1px solid gray;padding:1rem">
      Your BMI is ${SBMI}.<span style="color:green">You have Healty Weight. Keep it up:)</span><br>
      <a href="index.html" style="display:inline-block;background:#34495e;color:yellow;text-decoration:none;padding:10px">Refresh</a>
      </div>`;
    } else if (SBMI > 24.9 && SBMI < 29.9) {
      result_box.innerHTML = `<div style="display:inline-block;background:#9b59b6;color:yellow;box-shadow:0px 0px 5px black;border:1px solid gray;padding:1rem">
      Your BMI is ${SBMI}.<span style="color:yellow">You are Overweight.Do some Exersise:)</span><br>
      <a href="index.html" style="display:inline-block;background:#34495e;color:yellow;text-decoration:none;padding:10px">Refresh</a>
      </div>`;
    } else if (SBMI > 29.9) {
      result_box.innerHTML = `<div style="display:inline-block;background:#9b59b6;color:yellow;box-shadow:0px 0px 5px black;border:1px solid gray;padding:1rem">
      Your BMI is ${SBMI}.<span style="color:red">You have Obesity or more than Overweight. Do Some Exercise :)<span><br><a href="index.html" style="display:inline-block;background:#34495e;color:yellow;text-decoration:none;padding:10px">Refresh</a>
      </div>`;
    } else {
      result_box.innerHTML = `<div style="background:#9b59b6;color:yellow;box-shadow:0px 0px 5px black;border:1px solid gray;padding:1rem">Your BMI is ${SBMI}.<span style="color:red">Something went wrong</span><br>
      <a href="index.html" style="display:inline-block;background:#34495e;color:yellow;text-decoration:none;padding:10px">Refresh</a>
      </div>`;
    }
  }
...
function cal_metric_bmi() {
  ...
  if (heightInCentimeter == "" || weightInKg == "") {
    ...
    error_box.innerHTML = "";
    if (MBMI < 18.5) {
      result_box.innerHTML = `<div style="background:#9b59b6;color:yellow;box-shadow:0px 0px 5px black;border:1px solid gray;padding:1rem">Your BMI is ${MBMI}.<span style="color:yellow"> You are UnderWeight.Eat Some Extra Food today. Hahaha :)</span><br>
      <a href="index.html" style="display:inline-block;background:#34495e;color:yellow;text-decoration:none;padding:10px">Refresh</a></div>`;
      ...
      result_box.innerHTML = `<div style="display:inline-block;background:#9b59b6;color:yellow;box-shadow:0px 0px 5px black;border:1px solid gray;padding:1rem">
      Your BMI is ${MBMI}.<span style="color:red">You have Obesity or more than Overweight. Do Some Exercise :)<span><br><a href="index.html" style="display:inline-block;background:#34495e;color:yellow;text-decoration:none;padding:10px">Refresh</a>
      </div>`;
    } else {
      result_box.innerHTML = `<div style="background:#9b59b6;color:yellow;box-shadow:0px 0px 5px black;border:1px solid gray;padding:1rem">Your BMI is ${MBMI}.<span style="color:red">Something went wrong</span><br>
      <a href="index.html" style="display:inline-block;background:#34495e;color:yellow;text-decoration:none;padding:10px">Refresh</a>
      </div>`;
    }
  }
